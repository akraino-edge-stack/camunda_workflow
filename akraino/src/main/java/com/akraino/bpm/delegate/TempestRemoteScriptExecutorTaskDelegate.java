...
@Component
public class TempestRemoteScriptExecutorTaskDelegate implements JavaDelegate {

	
	
	 private static Logger logger = LoggerFactory.getLogger(TempestRemoteScriptExecutorTaskDelegate.class);
