...
@Component
public class AirshipScriptExecutorTaskDelegate implements JavaDelegate {

	 private static Logger logger = LoggerFactory.getLogger(AirshipScriptExecutorTaskDelegate.class);
