...
@Component
public class TempestScriptExecutorTaskDelegate implements JavaDelegate {

	@Autowired
	RuntimeService runtimeService;
	
	 private static Logger logger = LoggerFactory.getLogger(TempestScriptExecutorTaskDelegate.class);
