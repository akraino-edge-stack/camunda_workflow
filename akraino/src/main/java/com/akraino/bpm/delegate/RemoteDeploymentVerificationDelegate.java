...
@Component
public class RemoteDeploymentVerificationDelegate implements JavaDelegate {

	private static Logger logger = LoggerFactory.getLogger(RemoteDeploymentVerificationDelegate.class);
