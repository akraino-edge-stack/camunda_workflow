...
@Component
public class TempestRemoteDeploymentVerificationDelegate implements JavaDelegate {

	private static Logger logger = LoggerFactory.getLogger(TempestRemoteDeploymentVerificationDelegate.class);
